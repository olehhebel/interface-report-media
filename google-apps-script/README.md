...
5. Submit one real test through the site's **Book a sponsored story** form. The Vercel function calls the script, which sends an email to `doctorgebel@gmail.com`, with the applicant's email in Reply-To. Confirm delivery in that inbox; check Spam and the Apps Script **Executions** page if it fails.
