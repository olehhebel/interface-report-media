...
if(!document.querySelector('script[src="/assets/growth-20260923c.js"]')){
  const growth=document.createElement('script');growth.src='/assets/growth-20260923c.js';growth.async=false;document.head.appendChild(growth);
}
