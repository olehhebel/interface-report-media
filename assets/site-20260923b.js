...
if(!document.querySelector('script[src="/assets/growth-20260923b.js"]')){
  const growth=document.createElement('script');growth.src='/assets/growth-20260923b.js';growth.async=false;document.head.appendChild(growth);
}
