...
if(!document.querySelector('script[src="/assets/growth-20260925.js"]')){
  const growth=document.createElement('script');growth.src='/assets/growth-20260925.js';growth.async=false;document.head.appendChild(growth);
}
