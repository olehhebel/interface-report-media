...
if(!document.querySelector('script[src="/assets/growth.js"]')){
  const growth=document.createElement('script');growth.src='/assets/growth.js';growth.async=false;document.head.appendChild(growth);
}
